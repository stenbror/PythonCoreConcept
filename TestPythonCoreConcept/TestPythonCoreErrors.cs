...
namespace TestPythonCoreConcept
{
    public class TestPythonCoreErrors
    {
        ...
        [Fact]
        public void TestFileInputLambadVarArgsListFollowedByMulAndPowerError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("lambda a=b, /, *c, **: b\n".ToCharArray()));
            try
            {
                var rootNode = parser.ParseFileInput();
                Assert.True(false);
        ...
        [Fact]
        public void TestFileInputMultipleSmallStatementWithhoutSemicolonError()
        {
            ...
            {
                Assert.Equal(5u, e.Position);
                Assert.Equal("Expecting newline or ';' in statement list!", e.Message);
                Assert.Equal(TokenKind.PyPass, e.Symbol.Kind);
            }
            catch 
            {
        ...
        [Fact]
        public void TestFileInputExprMissingAfterColonError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("a:\n".ToCharArray()));
            try
            {
        ...
        [Fact]
        public void TestFileInputDelMissingExprError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("del;\n".ToCharArray()));
            try
            {
                var rootNode = parser.ParseFileInput();
                Assert.True(false);
        ...
        [Fact]
        public void TestFileInputNonlocalError()
        {
            ...
            {
                Assert.Equal(11u, e.Position);
                Assert.Equal("Expecting Name literal in nonlocal statement!", e.Message);
                Assert.Equal(TokenKind.PySemiColon, e.Symbol.Kind);
            }
            catch 
            {
        ...
        [Fact]
        public void TestFileInputAssertError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("assert;\n".ToCharArray()));
            try
            {
                var rootNode = parser.ParseFileInput();
                Assert.True(false);
        ...
        [Fact]
        public void TestFileInputAssertMissingAfterCommaError()
        {
        ...
        [Fact]
        public void TestFileInputImportDottedNameError()
        {
        ...
        [Fact]
        public void TestFileInputImportFromError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("from . import \n".ToCharArray()));
            try
            {
                var rootNode = parser.ParseFileInput();
                Assert.True(false);
        ...
        [Fact]
        public void TestFileInputImportFromParenthesisError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("from . import ( a\n".ToCharArray()));
            try
            {
                var rootNode = parser.ParseFileInput();
                Assert.True(false);
            ...
            {
                Assert.Equal(17u, e.Position);
                Assert.Equal("Missing ')' in import statement!", e.Message);
                Assert.Equal(TokenKind.Newline, e.Symbol.Kind);
            }
            catch 
            {
        ...
        [Fact]
        public void TestFileInputImportFromMissingArgumentError()
        {
            var parser = new PythonCoreParser(new PythonCoreTokenizer("from . import \n".ToCharArray()));
            try
            {
